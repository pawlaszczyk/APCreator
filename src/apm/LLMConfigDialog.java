...
public class LLMConfigDialog extends Application {
    ...
    private static final String CONFIG_FILE = "apmcreator-config.properties";
    ...
    public void start(Stage primaryStage) {
        configPath = Paths.get(System.getProperty("user.home"), CONFIG_FILE);
        ...
        HBox modelPathBox = new HBox(10, modelPathField, browseButton);
        ...
        gpuLayersSpinner = createIntegerSpinner(0, 100, 35, 1);
        ...
        temperatureSpinner = createDoubleSpinner(0.0, 2.0, 0.7, 0.1);
        ...
        //maxTokensSpinner = createIntegerSpinner(1, 8192, 2048, 256);
    ...
    private void loadConfig() {
        ...
        try (InputStream input = new FileInputStream(configPath.toFile())) {
            ...
            temperatureSpinner.getValueFactory().setValue(
                    Double.parseDouble(props.getProperty("temperature", "0.7")));
            ...
            //        Integer.parseInt(props.getProperty("max_tokens", "4096")));
